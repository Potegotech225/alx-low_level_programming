 ...
 * @e_ident:  pointer to a array containing the ELF magic numbers.
 *
...
/**
 * print_magic - It Prints  magic num of a ELF header.
 * @e_ident: pointer to a array containing the ELF magic numbers.
 *
 ...
 * @e_ident: pointer to a array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_type: The ELF type.
 * @e_ident:  pointer to n array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * ELF header at the start of a the ELF file.
 * @argc: The num of arguments going into the program.
